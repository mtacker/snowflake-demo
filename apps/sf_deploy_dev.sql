...
-- PROCEDURES
EXECUTE IMMEDIATE FROM @SNOWFLAKE_GIT_REPO/branches/dev/apps/pnc/snowflake_objects/databases/pnc_sales_db/schemas/bronze/storedProcedures/load_bronze_customer_orders.sql;
