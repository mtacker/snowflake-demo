...
-- EXECUTE IMMEDIATE FROM @SNOWFLAKE_GIT_REPO/branches/qa/apps/adm_platform/snowflake_objects/databases/adm_platform_db/schemas/tags/tags_build.sql;
-- -- Results in error:
-- -- "Unsupported feature 'session variables not supported during object dependencies backfill"
-- EXECUTE IMMEDIATE FROM @SNOWFLAKE_GIT_REPO/branches/qa/apps/adm_platform/snowflake_objects/databases/adm_platform_db/schemas/alerts/alerts_build.sql;
-- --------------------------------------------------------------------------------------------
