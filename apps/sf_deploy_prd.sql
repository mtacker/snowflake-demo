...
--------------------------------------------------------------------------------------------
-- tags.sql SUCCEEDS
-- EXECUTE IMMEDIATE FROM @SNOWFLAKE_GIT_REPO/branches/master/apps/adm_platform/snowflake_objects/databases/adm_platform_db/schemas/alerts/alerts.sql;
...
-- *******************************************************************************
-- EXECUTE IMMEDIATE FROM @SNOWFLAKE_GIT_REPO/branches/master/apps/adm_platform/snowflake_objects/databases/adm_platform_db/schemas/tags/tags.sql;
--------------------------------------------------------------------------------------------
